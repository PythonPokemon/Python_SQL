...
-- Musterlösung: SELECT AVG(Preis) AS "Durchschnittspreis" FROM MedLeistung;
...
JOIN MedLeistung ON Pat_MedLeistung.MLeistungNr = MedLeistung.MLeistungNr;
-- Musterlösung:
-- SELECT Patient.PatientName, Patient.PatientVorname, MedLeistung.Bezeichnung, Pat_MedLeistung.LeistungsDat
-- FROM Pat_MedLeistung
-- JOIN Patient ON Pat_MedLeistung.PatientNr = Patient.PatientNr
-- JOIN MedLeistung ON Pat_MedLeistung.MLeistungNr = MedLeistung.MLeistungNr;
