...
def zufaellige_mehrfachauswahl():
    ...
    auswahl = random.sample(zahlen, 2)      # es werden mit der methode/funktion: .sample() 3 eindeutige Elemente, aus der variable: 'zahlen' ausgewählt und in der variable: 'auswahl' gespeichert
