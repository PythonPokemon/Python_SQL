...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-12-08 10:04:04',NULL),('diagnostics.include_raw','OFF','2025-12-08 10:04:04',NULL),('ps_thread_trx_info.max_length','65535','2025-12-08 10:04:04',NULL),('statement_performance_analyzer.limit','100','2025-12-08 10:04:04',NULL),('statement_performance_analyzer.view',NULL,'2025-12-08 10:04:04',NULL),('statement_truncate_len','64','2025-12-08 10:04:04',NULL);
...
CREATE TABLE `artikel` (
  ...
  `Artikelgruppennummer` int NOT NULL,
  `Bezeichnung` text,
  `Preis` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`Artikelnummer`,`Artikelgruppennummer`),
  KEY `Artikelgruppennummer` (`Artikelgruppennummer`),
  CONSTRAINT `artikel_ibfk_1` FOREIGN KEY (`Artikelgruppennummer`) REFERENCES `artikelgruppe` (`Artikelgruppennummer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `artikel` VALUES (1,1,'Fernseher',799.00),(2,1,'Monitor',199.00),(3,2,'Tastatur',39.00),(4,2,'Maus',19.00),(5,3,'Hundefutter',49.00);
...
CREATE TABLE `artikelgruppe` (
  `Artikelgruppennummer` int NOT NULL AUTO_INCREMENT,
  `Bezeichnung` text NOT NULL,
  `Rabatt` decimal(5,2) NOT NULL,
  PRIMARY KEY (`Artikelgruppennummer`)
...
INSERT INTO `artikelgruppe` VALUES (1,'Elektronik',0.10),(2,'Peripherie',0.10),(3,'Tiernahrung',0.00);
...
CREATE TABLE `bestellung` (
  ...
  PRIMARY KEY (`Bestellnummer`,`Kundennummer`),
  KEY `Kundennummer` (`Kundennummer`),
  CONSTRAINT `bestellung_ibfk_1` FOREIGN KEY (`Kundennummer`) REFERENCES `kunde` (`Kundennummer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bestellung` VALUES (23,1,'2019-09-06'),(42,2,'2019-09-07'),(78,1,'2019-09-08'),(99,3,'2019-09-09');
...
INSERT INTO `kunde` VALUES (1,'Hubert','Klaus','Berlinerstr. 32','49377','Vechta'),(2,'Meier','Hans','Goethestr. 32','54434','Köln'),(3,'König','Jens','Eichenweg 43','12433','Berlin');
...
CREATE TABLE `position` (
  ...
  PRIMARY KEY (`Bestellnummer`,`Kundennummer`,`Artikelnummer`,`Artikelgruppennummer`),
  KEY `Artikelnummer` (`Artikelnummer`,`Artikelgruppennummer`),
  CONSTRAINT `position_ibfk_1` FOREIGN KEY (`Bestellnummer`, `Kundennummer`) REFERENCES `bestellung` (`Bestellnummer`, `Kundennummer`),
  CONSTRAINT `position_ibfk_2` FOREIGN KEY (`Artikelnummer`, `Artikelgruppennummer`) REFERENCES `artikel` (`Artikelnummer`, `Artikelgruppennummer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `position` VALUES (23,1,1,1,1),(42,2,1,1,1),(42,2,2,1,1),(42,2,3,2,2),(78,1,4,2,1),(99,3,5,3,1);
...
-- Dump completed on 2025-12-08 14:19:24
